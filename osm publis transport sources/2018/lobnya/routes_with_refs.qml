...
<qgis version="2.18.22-Las Palmas" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        ...
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="36,36,36,255"/>
          <prop k="line_style" v="solid"/>
  ...
  <aliases>
    ...
    <alias field="alignment" index="6" name=""/>
    <alias field="show_label" index="7" name=""/>
    <alias field="always_show" index="8" name=""/>
  </aliases>
...
⇥control = dialog.findChild(QWidget, "MyLineEdit")
  ...
  <defaults>
    ...
    <default field="alignment" expression=""/>
